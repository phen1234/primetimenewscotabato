...
if(heroVideos && heroVideos.parentElement){
...
async function loadVideos() { 
    ...
    setTimeout(() => { 
        startTicker(); 
    }, 800); // ginawa kong 800ms para sure tapos na animation
} 

function startTicker() { 
    const container = document.getElementById('heroVideos'); 
    const itemHeight = 124; // 110 + 14gap. ITO ANG IMPORTANTE
    const containerHeight = 496; // 124 x 4 = 4 videos kita
