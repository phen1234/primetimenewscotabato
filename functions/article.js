export async function onRequest(context) {
    ...
    try {
        ...
        // ==========================================
        // GET ORIGINAL ARTICLE.HTML
        // ==========================================

        const articleHtmlUrl =
            new URL(
                "/article.html",
                request.url
            );
        ...
        if (!assetResponse.ok) {
            ...
            console.error(
                "article.html could not be loaded:",
